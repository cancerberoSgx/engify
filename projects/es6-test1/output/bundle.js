...
console.log(output);
},{"./model/Model1":11,"./view/LayoutView":13}],11:[function(require,module,exports){
'use strict';
...
},{"./AbstractView":12,"./templates/layout.hbs":14}],14:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "hello form layout";
},"useData":true});
